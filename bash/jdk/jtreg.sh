...
eval $APPLY_ROOTFS_MODIFICATIONS
...
cd $JT_ROOT
ant -v -f jtreg-hg/make/build.xml -Djavatest.jar=/usr/share/java/javatest.jar \
    -Djh.jar=/usr/share/java/jh.jar -Djhall.jar=/usr/share/java/jhall.jar     \
